...
PUBLIC_HOST_WAS_SET="${MINING_CONTROL_PUBLIC_HOST+x}"
PUBLIC_HOST_OVERRIDE="${MINING_CONTROL_PUBLIC_HOST-}"
PUBLIC_PORT_WAS_SET="${MINING_CONTROL_PUBLIC_PORT+x}"
PUBLIC_PORT_OVERRIDE="${MINING_CONTROL_PUBLIC_PORT-}"
PUBLIC_URL_WAS_SET="${MINING_CONTROL_PUBLIC_URL+x}"
PUBLIC_URL_OVERRIDE="${MINING_CONTROL_PUBLIC_URL-}"
...
if [ "$PUBLIC_HOST_WAS_SET" = "x" ]; then
  MINING_CONTROL_PUBLIC_HOST="$PUBLIC_HOST_OVERRIDE"
fi
if [ "$PUBLIC_PORT_WAS_SET" = "x" ]; then
  MINING_CONTROL_PUBLIC_PORT="$PUBLIC_PORT_OVERRIDE"
fi
if [ "$PUBLIC_URL_WAS_SET" = "x" ]; then
  MINING_CONTROL_PUBLIC_URL="$PUBLIC_URL_OVERRIDE"
fi
...
MINING_CONTROL_HEARTBEAT_SECONDS="${MINING_CONTROL_HEARTBEAT_SECONDS:-300}"
MINING_CONTROL_HEARTBEAT_GRACE_SECONDS="${MINING_CONTROL_HEARTBEAT_GRACE_SECONDS:-180}"
